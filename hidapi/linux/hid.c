...
#warning "Custom HIDAPI code here"
						...
						is returning NULL for vitually generated devices only. Thus a quick fix is to handle such cases by
						giving the following member variables empty values. A deep look into libudev might be required
						in order to get values for the missing data fields.
						*/
